...
if not (os.path.isfile(f"./database/{shop_name}.db")):
    ...
    con.commit()
    cur.execute("CREATE TABLE users (id INTEGER, pw TEXT, token TEXT, role TEXT, money INTEGER, ip TEXT, buylog TEXT, isadmin INTEGER, warnings INTEGER, ban INTEGER, phone_number TEXT, bank_name TEXT);")
    con.commit()
    ...
    con.commit()
    cur.execute("""CREATE TABLE "user_buy_log" ("id" TEXT, "product_name" TEXT, "buy_code" TEXT, "amount" INTEGER, "buy_time" TEXT, "bank_name" TEXT);""")
    con.commit()
